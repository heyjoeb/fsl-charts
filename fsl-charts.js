...
$( document ).ready(function() {
  ...
  var npsProcess = new Chart(ctxProcess, {
      ...
      data: {
          labels: ['2020 - Q2', '2021 - Q1'],
          datasets: [{
              label: 'FullStackss systems and processes help me get my work done effectively',
              data: [3.84, 4.2],
              backgroundColor: [
                  'rgba(44, 106, 250, 100)',
                  'rgba(24, 204, 85,100)'
  ...
  var npsPriorities = new Chart(ctxPriorities, {
      ...
      data: {
          labels: ['2020 - Q2', '2021 - Q1'],
          datasets: [{
              label: 'Day-to-day decisions here demonstrate that quality and improvement are top prioritites',
              data: [4.39, 4.6],
              backgroundColor: [
                  'rgba(44, 106, 250, 100)',
                  'rgba(24, 204, 85,100)'
  ...
  var npsOpportunities = new Chart(ctxOpportunities, {
      ...
      data: {
          labels: ['2020 - Q2', '2021 - Q1'],
          datasets: [{
              label: 'I believe there are good career oportunities for me at FullStack Labs',
              data: [3.60, 4.1],
              backgroundColor: [
                  'rgba(44, 106, 250, 100)',
                  'rgba(24, 204, 85,100)'
  ...
  var npsStillWorking = new Chart(ctxStillWorking, {
      ...
      data: {
          labels: ['2020 - Q2', '2021 - Q1'],
          datasets: [{
              label: 'I see myself still working at FullStack Labs in one year time',
              data: [3.63, 4.3],
              backgroundColor: [
                  'rgba(44, 106, 250, 100)',
                  'rgba(24, 204, 85,100)'
  ...
  var npsInformed = new Chart(ctxInformed, {
      ...
      data: {
          labels: ['2020 - Q2'],
          datasets: [{
              label: 'The leaders at FullStack Labs keep people informed at what is happening',
              data: [4.49],
              backgroundColor: [
                  'rgba(44, 106, 250, 100)'
              ],
  ...
  var npsVision = new Chart(ctxVision, {
      ...
      data: {
          labels: ['2020 - Q2'],
          datasets: [{
              label: 'The leaders at FullStack Labs have communicated a vision that motivates me',
              data: [4.08],
              backgroundColor: [
                  'rgba(44, 106, 250, 100)'
              ],
